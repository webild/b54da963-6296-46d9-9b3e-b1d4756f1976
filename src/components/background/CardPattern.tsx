...
function CardPatternComponent({ mouseX, mouseY, randomString, isActive = false }: CardPatternProps) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className={`absolute inset-0 rounded bg-gradient-to-r from-blue-500 to-purple-600 backdrop-blur-xl transition duration-500 ${isActive ? 'opacity-100' : 'opacity-0 group-hover/card:opacity-100'}`}
        style={style}
      />
      <motion.div
