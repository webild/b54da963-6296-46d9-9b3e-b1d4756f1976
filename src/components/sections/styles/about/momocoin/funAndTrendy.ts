...
export function getFunAndTrendyAboutMomocoinStyle(
  ...
  return {
    ...
    button: {
      ...
      childClassName: "!px-0 h-13 md:!h-15 w-auto aspect-square rounded-full bg-white ring-2 ring-inset ring-black",
...
export const funAndTrendyMomocoinAboutStyle = getFunAndTrendyAboutMomocoinStyle(1);
